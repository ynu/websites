...
*/        if (g.controlNav) {
    ...
    b.fn.nivoSlider.defaults = {
        effect: (function(){
                 var isIE6=!!window.ActiveXObject&&!window.XMLHttpRequest;//for ie6
                 if(isIE6){return "fade";} else return "random";//for ie6
                })(),
        slices: 15,
        animSpeed: (function(){
                 var isIE6=!!window.ActiveXObject&&!window.XMLHttpRequest;//for ie6                
                 if(isIE6){return 0;} else return 500;//for ie6
                })(),
        pauseTime: 3000,
        startSlide: 0,
        directionNav: false,
